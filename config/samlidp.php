...
return [
    ...
    'sp' => [
        ...
        'aHR0cHM6Ly9zeW5jaHJvbm9zdXJlLmRlbW9zLmVucXVpcm9uLmNvbS9BcHAvSGFuZG9mZi9BdXRoU2RQ' => [
            // Your destination is the ACS URL of the Service Provider
            'destination' => 'https://synchronosure.demos.enquiron.com/App/Handoff/AuthSdP',
            'logout' => '',
            'certificate' => 'kms.enquiron.com.public.crt',
            'query_params' => false
        ]
    ],
